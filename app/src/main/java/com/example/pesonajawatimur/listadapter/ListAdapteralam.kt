package com.example.pesonajawatimur.listadapter
...
class ListAdapteralam(private val listWisata: ArrayList<Wisata>) : RecyclerView.Adapter<ListAdapteralam.ListViewHolder>(){
